...
export const seo = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      validation: (Rule) =>
        Rule.max(158).warning('Longer descriptions may be truncated by search engines'),
    }),
    defineField({
      name: 'keywords',
      title: 'Keywords',
    ...
    defineField({
      ...
      type: 'image',
      description:
        'Image displayed when sharing the page on social media (1200x630 pixels recommended)',
    }),
    defineField({
      name: 'noIndex',
      title: 'No Index',
